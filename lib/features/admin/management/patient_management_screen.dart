          ...
          children: [
            Row(
              ...
              children: [
                ...
                AarogyaBadge(
                  label: '${patients.length} Registered Patients',
            ...
            AarogyaTextField(
              hintText:
                  'Search patients by name, MRN / ID, or contact number...',
              ...
              child: filtered.isEmpty
                  ? AarogyaEmptyState(
                      ...
                      description: _query.isNotEmpty
                          ? 'No patients match "$_query". Check MRN, name, or phone number.'
                          : 'No patients are currently registered in the database.',
