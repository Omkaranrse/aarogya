    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          title: Text('Register Medical Specialist', style: AarogyaTypography.headingMedium(isDark ? Colors.white : Colors.black)),
          content: SizedBox(
            width: 440,
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  AarogyaTextField(label: 'Full Name', hintText: 'Dr. John Doe', controller: nameCtrl),
                  const SizedBox(height: AarogyaSpacing.md),
                  AarogyaTextField(label: 'Specialty', controller: specialtyCtrl),
                  const SizedBox(height: AarogyaSpacing.md),
                  AarogyaTextField(label: 'Qualifications', controller: qualCtrl),
                  const SizedBox(height: AarogyaSpacing.md),
                  AarogyaTextField(label: 'Consultation Fee (₹)', controller: feeCtrl, keyboardType: TextInputType.number),
                  const SizedBox(height: AarogyaSpacing.md),
                  AarogyaTextField(label: 'Hospital Affiliation', controller: hospitalCtrl),
                ],
              ),
            ),
          ),
                ...
                if (nameCtrl.text.trim().isNotEmpty) {
                  repo.addDoctor(
                    Doctor(
                      ...
                      rating: 5.0,
                      reviewsCount: 1,
                      consultationFee: double.tryParse(feeCtrl.text.trim()) ?? 1000,
            ...
            Wrap(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Specialist & Faculty Directory', style: AarogyaTypography.headingLarge(primaryText)),
                    Text(
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GlassCard(
                    glowColor: doc.isAvailableToday ? AarogyaColors.primaryCyan : Colors.grey,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Wrap(
                                    ...
                                    runSpacing: 4,
                                    children: [
                                      Text(doc.name, style: AarogyaTypography.title(primaryText)),
                                      AarogyaBadge(
                                        label: doc.isAvailableToday ? 'On OPD Duty' : 'Off-Duty',
                                        variant: doc.isAvailableToday ? AarogyaBadgeVariant.success : AarogyaBadgeVariant.neutral,
                                      ),
                                    ],
                                  ),
                                  const SizedBox(height: 2),
                                  Text(doc.specialty, style: AarogyaTypography.bodyMedium(AarogyaColors.primaryCyan)),
                                  const SizedBox(height: 2),
                                  Text(
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    height: 8,
                                    decoration: BoxDecoration(
                                      color: doc.isAvailableToday ? AarogyaColors.success : AarogyaColors.critical,
                                      shape: BoxShape.circle,
                                    ),
                                  ),
                                  const SizedBox(width: 6),
                                  Text(
                                    doc.isAvailableToday ? 'Available for OPD Today' : 'Off-Duty / Unavailable',
                                    style: AarogyaTypography.caption(doc.isAvailableToday ? AarogyaColors.success : secondaryText),
                                  ),
                                ],
                              ),
                              Transform.scale(
                                ...
                                child: Switch(
                                  ...
                                  activeColor: AarogyaColors.primaryCyan,
                                  onChanged: (_) {
