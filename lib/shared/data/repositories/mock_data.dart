...
class AarogyaMockData {
  ...
  static final List<Doctor> doctors = [
    const Doctor(
      ...
      timeSlots: ['09:00 AM', '10:00 AM', '11:30 AM', '02:00 PM', '04:30 PM', '06:00 PM'],
    ...
    const Doctor(
      ...
      avatarUrl: 'https://images.unsplash.com/photo-1594824813571-638f02614d3f?auto=format&fit=crop&q=80&w=300',
  ...
  static final List<Appointment> appointments = [
    Appointment(
      ...
      tokenNumber: 8,
      fee: 1200,
      symptoms: 'Mild chest discomfort during brisk jogging and morning fatigue.',
  ...
  static final List<QueueEntry> liveQueue = [
    QueueEntry(
      ...
      chiefComplaint: 'Post-medication blood pressure check & dizziness review.',
    ),
    QueueEntry(
      id: 'q-2',
      tokenNumber: 8,
    ...
    QueueEntry(
      ...
      chiefComplaint: 'Elevated BP reading (150/95) with palpitation sensation.',
    ),
    QueueEntry(
      id: 'q-4',
      tokenNumber: 10,
      ...
      status: QueueStatus.waiting,
      priority: PatientPriority.normal,
      chiefComplaint: 'Routine cardiac risk evaluation & lipid profile consult.',
    ),
  ];
  ...
  static final List<LabReport> sampleLabReports = [
    LabReport(
      ...
      labTechnicianNotes: 'Serum mildly lipemic. Specimen drawn after 12-hour fasting.',
    ),
    LabReport(
      id: 'lab-302',
      patientId: 'pat-1',
